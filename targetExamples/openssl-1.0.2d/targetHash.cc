...
extern "C" int LLVMFuzzerTestOneInput(const unsigned char *Data, size_t Size) {
	...
	int ints_i,ints_j,ints_c,ints_len,ints_counter=0;
	int ints_x_1=48;
	int ints_x_2=193;
	int ints_x_3=239;
	...
	int ints_h_1=0,ints_h_2=0,ints_h_3=0;
	for(int ints_a =0; ints_a < Size; ints_a++)
	  {
	    ints_h_1=(ints_h_1 + findParity(ints_x_1&Data[ints_a]))%2;
	    ints_h_2=(ints_h_2 + findParity(ints_x_2&Data[ints_a]))%2;
	    ints_h_3=(ints_h_3 + findParity(ints_x_3&Data[ints_a]))%2;
	  }
	if(ints_h_1==0)
	  ints_counter++;
	else
